...
export default function Home() {
  ...
  const signIn = (event: FormEvent<HTMLFormElement>) => {
    ...
    setError("");
    // The phone design is the teacher's viewing portal and intentionally has no role picker.
    const mobileTeacherPortal = window.matchMedia("(max-width: 700px)").matches;
    router.push(mobileTeacherPortal || role === "teacher" ? "/teacher" : "/staff");
  };
